...
day4_diets = {'HF': [6, 7, 8, 9, 10, 1, 2, 3, 5],
         'LF': [16, 18, 19, 11, 12, 13, 15]}

day10_diets = {'HF': [6, 7, 8, 9, 10, 11, 12, 13, 15],
               'LF': [16, 18, 19, 1, 2, 3, 5]}

day16_diets = day4_diets
day_diets = {4: day4_diets, 10: day10_diets, 16: day16_diets}
switch_diets = {'HF':'LF', 'LF':'HF'}

bacteria = ['BWH2',  'Bovatus', 'BtVPI', 'Bt7330']

bd_pairs = list( itertools.product(bacteria, diets) )

day4_bd_pairs = list( itertools.product(bacteria, day4_diets) )

mouse2diet = {}
for diet, mice in diets.items():
    for mouse in mice:
...
for day in days:
    for diet, mouse_nums in diets.items():
